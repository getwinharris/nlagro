...
class Product extends \Opencart\System\Engine\Controller {
	...
	public function index(): ?\Opencart\System\Engine\Action {
		...
		if ($product_info) {
			...
			// NNL: Determine product type (product, investment, organic)
			$data['product_type'] = 'product';
			$data['categories'] = '';

			// Get product categories
			$category_query = $this->db->query("SELECT cd.name
			...
			// Check if investment bond
			if (in_array('investment', $category_names) || in_array('bond', $category_names) || in_array('venture', $category_names)) {
				$data['product_type'] = 'investment';
			} elseif (in_array('organic', $category_names) || in_array('rice', $category_names) || in_array('millet', $category_names)) {
				$data['product_type'] = 'organic';
			}
